...
if (isset($_SESSION['id_user'])) { ?>
            <li class="nav-item">
              ...
              <li class="nav-item">
                  <a class="nav-link" href=""><?php echo $_SESSION['nom_role']?></a>  </li>';
            </li>
            <li class="nav-item">
          ...
          <!-- fin du controle -->
              ...
              <?php
                if(isset($_SESSION['nom_role'])){
                  
                  if($_SESSION['nom_role']==="Professeur"){
                   echo' <li class="nav-item">   <a class="nav-link" href="index.php?page=admin">Admin</a> </li>';
                  }
