...
if (isset($_POST['mdp'])) {
    ...
    $profilMD5 = $bdd->prepare('SELECT * FROM users WHERE email=:email AND mdp=:mdp ');
   
   
    $profilMD5 = $bdd->prepare("SELECT * FROM users WHERE email='sss@sss.ss' AND mdp='sqsqsqsqsq' ");

    $profilMD5 = $bdd->prepare("SELECT * FROM users WHERE email=''  or 1=1 -- ' AND mdp='sqsqsqsqsq' ");
